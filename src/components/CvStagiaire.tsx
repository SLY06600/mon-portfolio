...
import "@/styles/print.css"; // Styles pour impression
...
// ... Autres icônes inchangés (Phone, Location, Link)
...
interface CVComponentProps {
  data: CVData; // Remplacez 'any' par le type réel de vos données si connu
}

const CvStagiaire: React.FC<CVComponentProps> = ({ data }) => (
   ...
   <div className="min-h-screen bg-white py-4 px-2 cv-container">
      <div className="mx-auto grid grid-cols-1 md:grid-cols-3 border border-gray-200">
        ...
        <div className="p-3 md:col-span-2 text-[10px] space-y-3">
          ...
          <section>
            <h3 className="text-base font-bold text-blue-900 border-b border-blue-200 pb-1">À propos</h3>
            <p className="text-[10px] leading-snug">{data.about}</p>
          </section>

          <section>
            <h3 className="text-base font-bold text-blue-900 border-b border-blue-200 pb-1">Experiences</h3>
          ...
          <section>
            <h3 className="text-base font-bold text-blue-900 border-b border-blue-200 pb-1">Projets personnels</h3>
          ...
          <section>
            <h3 className="text-base font-bold text-blue-900 border-b border-blue-200 pb-1">Formation</h3>
            <ul className="space-y-2">
